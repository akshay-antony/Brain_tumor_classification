...
def train():
	...
	torch.save(model.state_dict(), "/home/akshay/ml_project/desnsenet_weights.pth", )
...
def test():
	...
	dataset = MyDataset(filename="/home/akshay/ml_project/labelled_test.csv", transform=custom_transforms, data_type='Testing')
	model = CNNNetwork()
